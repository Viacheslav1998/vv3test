<template>
  <div class="wp-cards lg:p-[32px] flex justify-center bg-zinc-400">
    <div class="lg:w-[80%]">
      <div class="wp-space max-lg:m-8 bg-[url('/part2/m24.jpg')] bg-cover bg-stone-300 lg:p-20 max-lg:p-5 my-10">
      ...
      <div class="box-cards bg-amber-300 max-lg:p-8">
        <!-- items -->
        <div class="flex max-lg:flex-col lg:justify-between">
          <div class="lg:w-80 rounded overflow-hidden shadow-lg bg-slate-100">
            ...
            <div class="px-6 py-4">
              ...
              <p class="text-gray-700" :class="sizeFont">
